...
export default function HomePage() {
  ...
  return (
    <main>
      <section className="hero-gradient px-4 pb-10 pt-8 sm:px-6 sm:pb-20 sm:pt-16">
        <div className="relative mx-auto max-w-6xl">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-200/90 sm:text-sm">
            IFK Mora OK
          </p>
          <h1 className="mt-2 max-w-3xl text-3xl font-bold tracking-tight text-white sm:mt-3 sm:text-5xl lg:text-[3.25rem] lg:leading-[1.1]">
          ...
          <div className="relative z-0 mt-8 grid grid-cols-2 gap-3 sm:mt-10 sm:grid-cols-3">
